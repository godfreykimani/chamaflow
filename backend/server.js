...
app.use(cors({ origin: (origin, cb) => (!origin || ALLOWED_ORIGINS.includes(origin)) ? cb(null, true) : cb(null, false), methods: ["GET","POST","PUT","DELETE","PATCH"], allowedHeaders: ["Content-Type","Authorization"] }));
...
{
  const phoneUpdates = [
    { name: "Cate Theuri",     phone: "0722828313", role: "Member"    },
    { name: "David Munene",    phone: "0722261215", role: "Member"    },
    { name: "Eliud Maina",     phone: "0724787052", role: "Member"    },
    { name: "Evelyn Kagwiria", phone: "0723683005", role: "Member"    },
    { name: "Felista Wandugi", phone: "0703322333", role: "Member"    },
    { name: "Gladys Muigai",   phone: "0700000006", role: "Member"    },
    { name: "Godfrey Kimani",  phone: "0715797246", role: "Chairman"  },
    { name: "Hannah Njoki",    phone: "0722878159", role: "Member"    },
    { name: "Jessie Nyaga",    phone: "0722864778", role: "Member"    },
    { name: "John Mwaura",     phone: "0722839581", role: "Member"    },
    { name: "Kellen Wanderi",  phone: "0700000011", role: "Member"    },
    { name: "Leah Wangui",     phone: "0722546049", role: "Member"    },
    { name: "Lydia Kibe",      phone: "0725240643", role: "Secretary" },
    { name: "Lydia Wangechi",  phone: "0722283488", role: "Member"    },
    { name: "Peris Njeri",     phone: "0722385680", role: "Member"    },
    { name: "Peter Ndichu",    phone: "0748210371", role: "Member"    },
    { name: "Rachel Mwaura",   phone: "0722935721", role: "Member"    },
    { name: "Wilson Wainaina", phone: "0723547560", role: "Member"    },
  ];
...
async function generateMeetingSummary(meetingId, transcript) {
  ...
  if (!ANTHROPIC_API_KEY || !transcript) return;
  try {
...
${transcript.slice(0, 8000)}`,
    ...
    if (!res.ok) { console.warn("[AI Summary] Claude error:", res.status); return; }
    ...
    console.log("[AI Summary] generated by Claude for meeting", meetingId);
  } catch (e) {
